...
"mfussenegger/nvim-jdtls",
    ...
    config = function()
        ...
        local function get_jdtls_paths()
            ...
            vim.list_extend(path.bundles, vim.split(vim.fn.glob("/home/$USER/.local/share/nvim/vscode-java-test/server/*.jar",1), "\n"))
        ...
        local function jdtls_on_attach(client, bufnr)
            ...
            vim.keymap.set("x", "<leader>jm", '<cmd>lua require("jdtls").extract_method(true)<CR>', opts)
            vim.keymap.set("x", "<leader>jv", '<cmd>lua require("jdtls").extract_variable(true)<CR>', opts)
            vim.keymap.set("x", "<leader>jc", '<cmd>lua require("jdtls").extract_constant(true)<CR>', opts)
        end
